...
const VoltageButton: React.FC<VoltageButtonProps> = ({ onClick, onMouseEnter, children, className = '', size = 'default' }) => {
  return (
    <div className={`voltage-button relative ${size === 'sm' ? 'size-sm' : ''} ${className}`}>
      <style>{`
        .voltage-button {
          position: relative;
        }
