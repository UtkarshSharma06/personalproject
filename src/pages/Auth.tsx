                    ...
                    <div className="bg-white dark:bg-card rounded-[2.5rem] sm:rounded-[3rem] p-8 sm:p-10 lg:p-12 border border-slate-100 dark:border-border shadow-2xl shadow-indigo-100/50 max-h-[95vh] overflow-y-auto no-scrollbar">
                        ...
                        <div className="space-y-6">
                            <Button
                                ...
                                className="w-full h-14 bg-white dark:bg-muted border-2 border-slate-200 dark:border-border hover:border-slate-300 rounded-xl flex items-center justify-center gap-3 transition-all hover:shadow-md"
                                disabled={isLoading}
                            >
                                ...
                                <span className="text-[10px] sm:text-[11px] font-black uppercase tracking-widest text-slate-700 dark:text-slate-300">
