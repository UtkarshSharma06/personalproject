...
export default function ReadingResult() {
    ...
    const fetchResult = async () => {
        try {
            ...
            // Fetch Questions (we need passage info too maybe, but questions are key)
            // We need to fetch passages to get questions related to them? 
            // The table structure: reading_passages -> reading_questions
            // Let's get passages first
        ...
        <Layout>
            <div className="container mx-auto px-6 py-12 max-w-5xl">
                ...
                <div className="flex items-center gap-4 mb-10">
                    ...
                    <h1 className="text-xl font-black uppercase text-slate-800">Reading Mission Report</h1>
                </div>
